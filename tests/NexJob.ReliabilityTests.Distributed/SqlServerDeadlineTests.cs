...
/// <summary>
/// Reliability tests for deadline enforcement on SqlServer.
/// </summary>
[Trait("Category", "Reliability.Distributed")]
public sealed class SqlServerDeadlineTests
      ...
      IClassFixture<SqlServerReliabilityFixture>
{
    ...
    public SqlServerDeadlineTests(SqlServerReliabilityFixture fixture)
        => _fixture = fixture;
