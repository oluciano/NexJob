...
/// <summary>
/// Reliability tests for wake-up signal latency and dispatch efficiency on Postgres.
/// </summary>
[Trait("Category", "Reliability.Distributed")]
public sealed class PostgresWakeUpLatencyTests
      ...
      IClassFixture<PostgresReliabilityFixture>
{
    ...
    public PostgresWakeUpLatencyTests(PostgresReliabilityFixture fixture)
        => _fixture = fixture;
