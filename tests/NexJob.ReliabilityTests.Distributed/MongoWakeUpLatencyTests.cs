...
/// <summary>
/// Reliability tests for wake-up signal latency and dispatch efficiency on Mongo.
/// </summary>
[Trait("Category", "Reliability.Distributed")]
public sealed class MongoWakeUpLatencyTests
    : DistributedReliabilityTestBase,
      IClassFixture<MongoReliabilityFixture>
{
    private readonly MongoReliabilityFixture _fixture;

    public MongoWakeUpLatencyTests(MongoReliabilityFixture fixture)
        => _fixture = fixture;
