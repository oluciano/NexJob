...
/// <summary>
/// Reliability tests for deadline enforcement on Postgres.
/// </summary>
[Trait("Category", "Reliability.Distributed")]
public sealed class PostgresDeadlineTests
      ...
      IClassFixture<PostgresReliabilityFixture>
{
    ...
    public PostgresDeadlineTests(PostgresReliabilityFixture fixture)
        => _fixture = fixture;
