...
/// Targets 100% coverage for parsing and state identification across all providers.
/// </summary>
public sealed class StorageLogicHardeningTests
{
    // ─── SQL Server ──────────────────────────────────────────────────────────
    ...
    /// <summary>Tests MongoDB filter creation for JobId.</summary>
    [Fact]
    public void MongoDB_ByIdFilter_CreatesSuccessfully()
    {
